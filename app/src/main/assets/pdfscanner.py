...
url = 'http://172.17.3.180:8080/video'
...
while ret:
    ...
    if k == ord('s'):
        ...
        if k1 == ord('b'):
            ...
            cv2.imwrite("/Users/atharvaverma/Desktop/webcam/scanned%d.jpg" % i, gray)
            i = i + 1
            continue
        elif k1 == ord('u'):
            cv2.destroyWindow('scanned photo')
            ...
            cv2.imwrite("/Users/atharvaverma/Desktop/webcam/scanned%d.jpg" % i, new)
            i = i + 1
            continue
        elif k1 == ord('c'):
            cv2.destroyWindow("scanned photo")
            cannied = cv2.Canny(frame, 200, 250)
            cv2.imwrite("/Users/atharvaverma/Desktop/webcam/scanned%d.jpg" % i, cannied)
            i = i + 1
            continue
        elif k1 == ord('y'):
            cv2.destroyWindow("scanned photo")
            ...
            cv2.imwrite("/Users/atharvaverma/Desktop/webcam/scanned%d.jpg" % i, frame)
            i = i + 1
            continue
...
cap.release()
imagelist = os.listdir("/Users/atharvaverma/Desktop/webcam")
pdf = FPDF()
for image in imagelist:
    image = "/Users/atharvaverma/Desktop/webcam" + image
    pdf.add_page()
    pdf.image(image)
pdf.output("/Users/atharvaverma/Desktop/webcam")
